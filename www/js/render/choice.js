...
export function rChoice(choice){
  ...
  return '<div style="margin-bottom:1.5rem"><h2 id="scr-h" style="color:#2d4a1e;margin-bottom:6px">We found two sets of answers</h2>' +
    ...
    '<button type="button" class="btn primary" style="width:100%;justify-content:center;padding:14px;margin-top:8px" data-action="keepCloud">Keep the answers in my account</button></div>' +
    ...
    '<button type="button" class="btn primary" style="width:100%;justify-content:center;padding:14px;margin-top:8px" data-action="keepLocal">Keep the answers on this device</button></div>' +
